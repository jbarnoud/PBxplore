# -*- coding: utf-8 -*-
#
# PBxplore API documentation build configuration file, created by
...
htmlhelp_basename = 'PBxploreAPIdoc'
...
latex_documents = [
  (master_doc, 'PBxploreAPI.tex', u'PBxplore API Documentation',
   u'Pierre Poulain and others', 'manual'),
]
...
man_pages = [
    (master_doc, 'pbxploreapi', u'PBxplore API Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PBxploreAPI', u'PBxplore API Documentation',
   author, 'PBxploreAPI', 'One line description of project.',
   'Miscellaneous'),
]
